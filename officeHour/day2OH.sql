...
-- 4. write a SQL query to find all those employees who work in department ID 80 or 40. Return first name, last name,
...
-- 17. write a SQL query to find those employees who report that manager whose first name is ‘Payam’. Return first name,
-- last name, employee ID and salary.
...
-- 18. write a SQL query to find all those employees who work in the Finance department. Return department ID,
...
-- 21. write a SQL query to find those employees who do not work in those departments where manager ids are
-- in the range 100, 200 (Begin and end values are included.) Return all the fields of the employees.
SELECT *
FROM EMPLOYEES
